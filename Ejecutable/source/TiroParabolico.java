...
public class TiroParabolico extends PApplet {
...
PVector acc;
 ...
 public void setup() {
  ...
  posIni = new PVector(width*0.2f, height*0.8f);
 ...
 public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TiroParabolico" };
    if (passedArgs != null) {
